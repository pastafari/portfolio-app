...
class InvestmentsControllerTest < ActionController::TestCase
  ...
  test "should create investment" do
    assert_difference('Investment.count') do
      post :create, investment: { company_id: @investment.company_id, cost: @investment.cost, portfolio_id: @investment.portfolio_id, quantity: @investment.quantity }
    end
  ...
  test "should update investment" do
    put :update, id: @investment, investment: { company_id: @investment.company_id, cost: @investment.cost, portfolio_id: @investment.portfolio_id, quantity: @investment.quantity }
    assert_redirected_to investment_path(assigns(:investment))
  end
